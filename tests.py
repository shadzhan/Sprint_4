...
class TestBooksCollector:
    ...
    def test_get_book_genre_existing_book(self, collector):
        ...
        assert collector.get_book_genre('Капитан Немо') == ''

    def test_get_book_genre_of_nonexisting_book(self, collector):
    ...
    def test_get_books_with_specific_genre(self, collector):
        ...
        assert collector.get_books_with_specific_genre('Исторический роман') == []

    def test_get_books_for_children(self, collector):
        collector.add_new_book('Весёлые истории')
        collector.set_book_genre('Весёлые истории', 'Мультфильмы')
        collector.add_new_book('Лангольеры')
        collector.set_book_genre('Лангольеры', 'Ужасы')

        children_books = collector.get_books_for_children()
        assert 'Весёлые истории' in children_books
        assert 'Лангольеры' not in children_books
    ...
    def test_add_book_in_favorites_same_books(self, collector):
        collector.add_new_book('Голова профессора Доуля')
        collector.add_book_in_favorites('Голова профессора Доуля')
        collector.add_book_in_favorites('Голова профессора Доуля')
        assert collector.get_list_of_favorites_books() == ['Голова профессора Доуля']
